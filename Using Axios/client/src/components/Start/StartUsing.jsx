...
import QEHRS from "../.././assets/QEHRs.png";
...
const StartUsing = () => {
  ...
  return (
      <div style={myStyle}>
        <br />
        <br />
        <img className='image' style = {{borderRadius: '20%', width: '7%', display: 'block', 
                               marginLeft: 'auto', marginRight: 'auto', backgroundColor: 'blue' }} 
                               src={QEHRS} alt="no img found" />
        <br />
        <br />
        <h1 className='text-center display-1 text-danger fw-bold'> Choose Your Role </h1>
        <br /><br />
        <div className='rowC'>
          <div className='colC'>
